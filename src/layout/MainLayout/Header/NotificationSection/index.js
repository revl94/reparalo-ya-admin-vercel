                                    ...
                                    <PerfectScrollbar className={ classes.ScrollHeight }>
                                        ...
                                        <ListItem button alignItems='flex-start' className={ classes.pT0 }>
                                            ...
                                            <ListItemText
                                                ...
                                                secondary={ <Typography variant='subtitle2'>New ticket
                                                    Added</Typography> }
                                            />
                                        ...
                                        <ListItem button alignItems='flex-start' className={ classes.pT0 }>
                                            ...
                                            <ListItemText
                                                ...
                                                secondary={ <Typography variant='subtitle2'>Purchase a new
                                                    product</Typography> }
                                            />
                                            <ListItemSecondaryAction className={ classes.listAction }>
                                                <Grid container justifyContent='flex-end'>
                                        ...
                                        <ListItem button alignItems='flex-start'>
                                            ...
                                            <ListItemText
                                                ...
                                                secondary={ <Typography variant='subtitle2'>Currently
                                                    Login</Typography> }
                                            />
                                            <ListItemSecondaryAction className={ classes.listAction }>
                                                <Grid container justifyContent='flex-end'>
